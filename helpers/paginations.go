...
func GeneratePaginationRequestAdmin(context *gin.Context) *dtos.Pagination {
	// default limit, page & sort parameter
	limit := 10
	page := 1
	sort := "created_at desc"
...
func GeneratePaginationRequestPendaftaran(context *gin.Context) *dtos.Pagination {
	// default limit, page & sort parameter
	limit := 10
	page := 1
	sort := "created_at desc"
...
func GeneratePaginationRequestDokumen(context *gin.Context) *dtos.Pagination {
	// default limit, page & sort parameter
	limit := 10
	page := 1
	sort := "created_at desc"
